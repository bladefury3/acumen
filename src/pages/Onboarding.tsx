...
const steps = [
  ...
  },
  {
    ...
    options: [
      { label: "Improve student engagement", value: "engagement" },
      { label: "Differentiate instruction", value: "differentiation" },
      { label: "Integrate technology", value: "technology" },
      { label: "Assessment strategies", value: "assessment" },
    ],
    key: "goals" as const,
  },
];
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="space-y-6">
          ...
          <PreferenceCheckboxGroup
            ...
            selectedValues={preferences[currentStepData.key]}
